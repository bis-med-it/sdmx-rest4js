...
const versions: { [key: string]: string } = {
  ...
  // The version of the SDMX RESTFul API released in October 2018. It
  // introduces the new valididty API, adds new resources, generalizes the use
  // of the + operator, etc.
  v1_3_0: 'v1.3.0',
  ...
  // The version of the SDMX RESTFul API released in September 2020. The
  // release adds support for VTL artefacts and extends the list of supported
  // media types for schema queries.
  v1_5_0: 'v1.5.0',
...
const getKeyFromVersion = (v: string): string => v.replace(/\./g, '_');

export const ApiVersion = Object.freeze(versions);
export const ApiResources = Object.freeze(resources);
export const ApiNumber = Object.freeze(numbers);
export { getKeyFromVersion };
