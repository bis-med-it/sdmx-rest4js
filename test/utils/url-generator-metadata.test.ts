...
describe('URL Generator for metadata queries', () => {
  it('generates a URL for a metadata query', () => {
    const expected =
      'http://sdw-wsrest.ecb.europa.eu/service/codelist/ECB/CL_FREQ/' +
  ...
  it('generates a URL for a metadata ItemScheme query', () => {
    const expected =
      'http://test.com/service/codelist/all/all/' +
  ...
  it('generates a URL for a metadata non-ItemScheme query', () => {
    const expected =
      'http://test.com/service/dataflow/all/all/' +
      'latest?detail=full&references=none';
  ...
  it('supports item queries for API version 1.1.0 and above', () => {
    const expected =
      'http://test.com/codelist/ECB/CL_FREQ/latest/A' +
  ...
  it('does not support item queries before API version 1.1.0', () => {
    const expected =
      'http://test.com/codelist/ECB/CL_FREQ/latest' +
      '?detail=full&references=none';
    const query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('treats hierarchical codelists as item schemes for API version 1.2.0', () => {
    const expected =
      'http://test.com/hierarchicalcodelist/BIS/HCL/latest/HIERARCHY' +
      '?detail=full&references=none';
    const query = MetadataQuery.from({
  ...
  it('does not support hiearchy queries before API version 1.2.0', () => {
    const expected =
      'http://test.com/hierarchicalcodelist/BIS/HCL/latest' +
      '?detail=full&references=none';
    const query = MetadataQuery.from({
      resource: 'hierarchicalcodelist',
      id: 'HCL',
  ...
  it('Supports multiple artefact types since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist,dataflow/*/*/~' +
      '?detail=full&references=none';
  ...
  it('Supports all for artefact types via * since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/*/*/*/~' + '?detail=full&references=none';
  ...
  it('supports multiple agencies for API version 1.3.0 and above', () => {
    let expected =
      'http://test.com/codelist/ECB+BIS/CL_FREQ/latest/all' +
      '?detail=full&references=none';
    ...
    expected =
      'http://test.com/structure/codelist/ECB,BIS/CL_FREQ/~/*' +
      '?detail=full&references=none';
  ...
  it('Rewrites * for agencies before API version 2.0.0', () => {
    let expected =
      'http://test.com/codelist/all/CL_FREQ/latest/all' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('Rewrites all for agencies since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/*/CL_FREQ/~/*' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('supports multiple IDs for API version 1.3.0 and above', () => {
    const expected =
      'http://test.com/codelist/ECB/CL_FREQ+CL_DECIMALS/latest/all' +
      '?detail=full&references=none';
    const query = MetadataQuery.from({
      resource: 'codelist',
  ...
  it('Rewrites , for multiple resource IDs before API version 2.0.0', () => {
    let expected =
      'http://test.com/codelist/BIS/CL_FREQ+CL_DECIMALS/latest/all' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ,CL_DECIMALS',
  ...
  it('Rewrites + for multiple resource IDs since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/BIS/CL_FREQ,CL_UNIT/~/*' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ+CL_UNIT',
  ...
  it('Rewrites * for resource IDs before API version 2.0.0', () => {
    let expected =
      'http://test.com/codelist/BIS/all/latest/all' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: '*',
  ...
  it('Rewrites all for resources IDs since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/BIS/*/~/*' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'all',
  ...
  it('supports multiple versions for API version 1.3.0 and above', () => {
    let expected =
      'http://test.com/codelist/ECB/CL_FREQ/1.0+1.1/all' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
    ...
    expected =
      'http://test.com/structure/codelist/ECB/CL_FREQ/1.0.0,1.1.0/*' +
      '?detail=full&references=none';
    query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('supports multiple items for API version 1.3.0 and above', () => {
    const expected =
      'http://test.com/codelist/ECB/CL_FREQ/1.0/A+M' +
      '?detail=full&references=none';
    const query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('Rewrites + for multiple items since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/BIS/CL_FREQ/~/A,M' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('Rewrites * for items before API version 2.0.0', () => {
    let expected =
      'http://test.com/codelist/BIS/CL_FREQ/1.0/all' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('Rewrites all for items since API 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/BIS/CL_FREQ/1.0/*' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      id: 'CL_FREQ',
  ...
  it('offers to skip defaults but adds params when needed (detail & refs)', () => {
    const expected =
      'http://test.com/codelist?detail=allstubs&references=datastructure';
    const query = MetadataQuery.from({
      resource: 'codelist',
      detail: 'allstubs',
      references: 'datastructure',
  ...
  it('supports raw since 2.0.0', () => {
    let expected =
      'http://test.com/structure/codelist/*/*/~/*?' +
  ...
  it('supports VTL artefacts since v1.5.0 (references)', () => {
    ...
    const query = MetadataQuery.from({
      resource: 'codelist',
      references: 'transformationscheme',
    });
    const service = Service.from({
      url: 'http://test.com',
      api: ApiVersion.v1_5_0,
  ...
  it('does not support VTL artefacts before v1.5.0 (references)', () => {
    ...
    should.Throw(
      test,
      Error,
      'transformationscheme not allowed as reference in v1.2.0',
    );
  });
  ...
  it('supports semver since v2.0.0 (version)', () => {
    let expected =
      'http://test.com/structure/codelist/BIS/CL_FREQ/1.2+.0/*?' +
      'detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'codelist',
      agency: 'BIS',
  ...
  it('rewrites version keywords since v2.0.0', () => {
    let expected =
      'http://test.com/structure/dataflow/BIS/EXR/~' +
      '?detail=full&references=none';
    let query = MetadataQuery.from({
      resource: 'dataflow',
      agency: 'BIS',
